...
```
Risk Level    Capital Risk    Expected Return
    │              │               │
 R1 ├──────────────┼───────────────┤  Very Low Risk, Low Return
    │   ░░░        │      ▓▓       │
 R2 ├──────────────┼───────────────┤  Low Risk, Modest Return
    │   ░░░░░      │      ▓▓▓▓     │
 R3 ├──────────────┼───────────────┤  Medium Risk, Balanced Return
    │   ░░░░░░░    │      ▓▓▓▓▓▓   │
 R4 ├──────────────┼───────────────┤  High Risk, High Return
    │   ░░░░░░░░░  │      ▓▓▓▓▓▓▓▓ │
 R5 ├──────────────┼───────────────┤  Very High Risk, Max Return
    │   ░░░░░░░░░░░│      ▓▓▓▓▓▓▓▓▓│
    └──────────────┴───────────────┘
```
